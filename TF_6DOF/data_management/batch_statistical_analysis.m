...
%   - Plots saved to 'results/figures/' when save_plots is true
%
...
function stats = batch_statistical_analysis(run_names)
    ...
    generate_batch_plots(stats, data_matrix, save_plots, base_dir);
...
function generate_batch_plots(stats, data_matrix, save_plots, base_dir)
    ...
    % Save figure 1
    if save_plots
        exportgraphics(fig1, fullfile(fig_dir, sprintf('batch_metric_means_%s.pdf', timestamp)), 'ContentType', 'vector');
        exportgraphics(fig1, fullfile(fig_dir, sprintf('batch_metric_means_%s.png', timestamp)), 'Resolution', 300);
        fprintf('  Saved: batch_metric_means\n');
    end
    ...
    % Save figure 2
    if save_plots
        exportgraphics(fig2, fullfile(fig_dir, sprintf('batch_boxplots_%s.pdf', timestamp)), 'ContentType', 'vector');
        exportgraphics(fig2, fullfile(fig_dir, sprintf('batch_boxplots_%s.png', timestamp)), 'Resolution', 300);
        fprintf('  Saved: batch_boxplots\n');
    end
    ...
    if ~isempty(stats.correlation) && isfield(stats.correlation, 'matrix')
        ...
        % Save figure 3
        if save_plots
            exportgraphics(fig3, fullfile(fig_dir, sprintf('batch_correlation_%s.pdf', timestamp)), 'ContentType', 'vector');
            exportgraphics(fig3, fullfile(fig_dir, sprintf('batch_correlation_%s.png', timestamp)), 'Resolution', 300);
            fprintf('  Saved: batch_correlation\n');
        end
    end
    ...
    % Save figure 4
    if save_plots
        exportgraphics(fig4, fullfile(fig_dir, sprintf('batch_score_dist_%s.pdf', timestamp)), 'ContentType', 'vector');
        exportgraphics(fig4, fullfile(fig_dir, sprintf('batch_score_dist_%s.png', timestamp)), 'Resolution', 300);
        fprintf('  Saved: batch_score_dist\n');
