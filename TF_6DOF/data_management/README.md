...
Each plot opens in its own figure window:

1. **State Machine Transitions** - State over time + transition markers
2. **3D Trajectory** - Color-coded by time
3. **Altitude Tracking** - Reference vs estimated with error
4. **Terrain Alpha** - α tracking vs robot roll
5. **Terrain Beta** - β tracking vs robot pitch
6. **Robot Roll/Pitch/Yaw** - 3 separate figures
7. **Control Inputs** - 6 figures (surge, sway, heave, roll, pitch, yaw)
8. **Normal Parallelism** - Alignment angles over time
9. **Innovation** - EKF innovation per sensor + norm
10. **SBES Measurements** - 4 sensors measured vs predicted
11. **EKF Position XYZ** - Position vs ground truth
12. **EKF Position Angles** - Orientation vs ground truth
13. **EKF Position Velocities** - Velocity vs ground truth
14. **EKF Position Errors** - All estimation errors
15. **Sensor Failures** - Failure timeline
