...
t_react = 0.2;          % [s] Controller reaction time
...
freq_sbes = 400;        % [kHz] SBES frequency (200/400 kHz typical)
sigma_sbes = 0.005;     % [m] Sensor resolution (depth measurement error)
beamwidth = deg2rad(4.0);        % [deg] Beam opening angle (typically 4-8°)
