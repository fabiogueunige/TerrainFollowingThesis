...
% HEADER
\ifpdf
    \pdfinfo {/Title (Advanced AUV Motion Control and Terrain Following for Automatic Seabed Inspection)
              /Creator (TeX)
              /Producer (pdfTeX)
              /Author (Fabio Guelfi)
...
\title{Advanced AUV Motion Control and Terrain Following for Automatic Seabed Inspection}
...
\ifpdf
  ...
  \supervisors{
  	  \begin{tabular}{rl}
  		Prof. &  \myhlink{mailto:name@unige.it}{Enrico Simetti} \\
  		Prof. & \myhlink{mailto:name@tecnico.ulisboa.pt}{Antonio Pascoal}  \\
  	\end{tabular}
  	}
